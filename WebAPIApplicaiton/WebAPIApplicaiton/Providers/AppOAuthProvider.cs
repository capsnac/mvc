...
namespace WebAPIApplicaiton.Providers
{
    /// <summary>
    ...
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        /// </summary>
        private WebAPIDBEntities databaseManager = new WebAPIDBEntities();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = ur.GetUserByCredentials(usernameVal, passwordVal);
            ...
            AuthenticationProperties properties = CreateProperties(userInfo.Email, (bool)userInfo.IsAdmin, (bool)userInfo.IsActive);
        ...
        public static AuthenticationProperties CreateProperties(string userName, bool isAdmin, bool isActive)
        {
            // Settings.
